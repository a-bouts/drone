...
impl MspRequest {
    pub fn command_code(&self) -> MspCommandCode {
        match self {
            ...
            MspRequest::MspIdent => MspCommandCode::MSP_IDENT,
            MspRequest::MspStatus => MspCommandCode::MSP_STATUS,
...
impl From<MspRequest> for MspPacket {
    fn from(request: MspRequest) -> Self {
        match request {
            ...
            MspRequest::MspIdent => MspPacket {
                cmd: MspCommandCode::MSP_IDENT.to_primitive(),
                direction: ToFlightController,
                data: MspPacketData::new(), // empty
            },
            MspRequest::MspStatus => MspPacket {
